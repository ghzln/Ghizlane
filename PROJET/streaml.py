...
dataset=pd.read_excel("PROJET.xlsx")
...
profit_by_category_piechart=px.pie(profit_by_category,names=profit_by_category.index,values="PROFIT",
                                   title="profit % By Category",hole=.3,color=profit_by_category.index,color_discrete_sequence=px.colors.sequential.RdPu_r)
